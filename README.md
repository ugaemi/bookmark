...
- [웹 기반 애플리케이션 디자인 통합 전략 12팩터](https://12factor.net/)
...
- [Django views and locals antipattern](https://2scoops.co/django-views-and-locals-antipattern)
...
- [Three things not to put in DB](https://www.revsys.com/tidbits/three-things-you-should-never-put-your-database/)
